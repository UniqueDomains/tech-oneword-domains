# Available .TECH One-Word Domains (5,622,055)
...
**Public extract:** 10,000 rows · **Live catalog:** 5,622,055 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/tech?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_tech_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/tech?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_tech_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./tech.csv">CSV</a> / <a href="./tech.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_tech_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_tech_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TECH search](https://unique.domains/domains/tld/tech?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_tech_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TECH search](https://unique.domains/domains/tld/tech?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_tech_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./tech.csv) or [Download JSON](./tech.json)
...
| ------------------------ | ------------------------------------------------ |
| 10,000-row public sample | 5,622,055 live domains                           |
...
> Unique Domains. *Available .TECH One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
